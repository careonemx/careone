...
/**
 * Perfil de recepcionista (1:1 con {@link Usuario}). Tenant-aware.
 * <p>{@code doctor == null} -> compartida por toda la clinica.
 * <p>{@code doctor != null} -> asignada a ese doctor.
 */
@Entity
...
public class Recepcionista extends Auditable implements TenantAware {
    ...
    /** NULL = compartida por toda la clinica. */
